...
export const PROPS = {
  ...
  // 밤의 저택 흉기 (손목에서 팔 방향으로 뻗는다)
  dagger: `<path d="M-4 -4 H4 V22 H-4Z" fill="#5a2a1a" stroke="${INK}" stroke-width="2"/><path d="M-13 20 H13 V26 H-13Z" fill="#e0b030" stroke="${INK}" stroke-width="2"/><path d="M-6 26 L6 26 L2 92 L0 100 L-2 92Z" fill="#dfe4ec" stroke="${INK}" stroke-width="2"/><path d="M0 30 V90" stroke="#9aa0aa" stroke-width="1.6"/>`,
  candle: `<path d="M-3 -10 H3 V40 H-3Z" fill="#d8dce4" stroke="${INK}" stroke-width="2"/><path d="M-14 -16 Q0 -8 14 -16 L10 -8 H-10Z" fill="#c8ccd4" stroke="${INK}" stroke-width="2"/><path d="M-12 40 H12 L8 48 H-8Z" fill="#d8dce4" stroke="${INK}" stroke-width="2"/>
    <path d="M-6 48 H6 V84 H-6Z" fill="#f4ecd8" stroke="${INK}" stroke-width="2"/><path d="M0 84 C-7 92 -5 102 0 108 C5 102 7 92 0 84Z" fill="#ffcf5a" stroke="#e07a1a" stroke-width="1.6"/><circle cy="98" r="24" fill="#ffd070" opacity=".25"/>`,
  rope: `<path d="M0 0 C-4 20 4 30 0 44" stroke="#c8a060" stroke-width="7" fill="none" stroke-linecap="round"/><ellipse cx="0" cy="66" rx="22" ry="26" fill="none" stroke="#c8a060" stroke-width="7"/><ellipse cx="0" cy="66" rx="22" ry="26" fill="none" stroke="${INK}" stroke-width="1.4" stroke-dasharray="4 5"/>`,
